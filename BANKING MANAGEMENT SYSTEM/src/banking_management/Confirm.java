...
public class Confirm extends javax.swing.JFrame {
    ...
    public Confirm() {
        ...
        try {
            ...
            String query="select acc_no,pin from info ";
            ...
            //ps=(PreparedStatement)connect.prepareStatement("SELECT * from info WHERE acc_no=? AND pin=?");
    ...
    private void initComponents() {
        ...
        jLabel4.setText("*Please remember your Account number and PIN");

        jLabel1.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 22, 223));
